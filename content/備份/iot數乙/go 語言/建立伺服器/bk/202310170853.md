...
        // arid3 := make([]opts.LineData, 0)

        // for i := 0; i < 7; i++ {

        //  arid3 = append(arid3, opts.LineData{Value: rand.Intn(300)})
...
        //arid = append(arid2, opts.LineData{Value: id})
...
        // *artemperature = artemperature2

        // *arhumidity = arhumidity2

        // *arcreate_time = arcreate_time2
