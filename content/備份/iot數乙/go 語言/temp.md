...
    var strsql string = "update userinfo set username=? where uid=?"

    db, err := sql.Open(sqltype, "root:@/gosql?charset=utf8") //needcheck 20231005Q
...
    stmt, err := db.Prepare(strsql) //這邊有問題
...
func create_data() { //沒有用到 或是可以跟read_data 一起用
