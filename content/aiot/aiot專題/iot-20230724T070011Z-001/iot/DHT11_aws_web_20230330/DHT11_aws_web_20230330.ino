...
#ifndef STASSID
#define STASSID "AIMESH91" //AIMESH92
#define STAPSK  "91abcd1234" //92abcd1234
#endif
...
void connToServer(float *temp, float *humi){
  ...
  if ((WiFi.status() == WL_CONNECTED)) {
    ...
    if (http.begin(client, "http://18.207.214.104/iot/recieve_data.php?temp="+(String)sensor_temp+"&humi="+(String)sensor_humi)) {  // HTTP
