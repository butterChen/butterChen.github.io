...
func deletemongo2() {
	...
	// 	CaseLevel: false,
	// })
	// res, err := coll.DeleteOne(context.TODO(), bson.D{{"x", "1"}}, opts)
	res, err := coll.DeleteOne(context.TODO(), bson.D{{"x", 1}})
	if err != nil {
		log.Fatal(err)
	}
